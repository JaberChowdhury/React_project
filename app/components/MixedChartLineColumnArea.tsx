...
export type MixedChartLineColumnAreaProps = {
  datas: {
    count: number[];
    characters: string[];
  };
...
const MixedChartLineColumnAreaComponent = ({
  datas,
  title,
}: MixedChartLineColumnAreaProps) => {
...
export default MixedChartLineColumnAreaComponent;
