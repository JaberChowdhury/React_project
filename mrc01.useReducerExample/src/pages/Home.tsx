...
function Home() {
  const data: string[] = ["Search", "TodoApp", "TextUtils", "Counter"];
  return (
    <Div className="w-full min-h-screen flex justify-center items-center flex-col relative p-2 bg-slate-100">
